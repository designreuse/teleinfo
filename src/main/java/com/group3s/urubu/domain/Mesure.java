package com.group3s.urubu.domain;
...
public class Mesure {
	...
	private String adco; // Adresse du concentrateur de téléreport - 12car
   ...
   // private Integer ejphpm; // Index option EJP, Heures de Pointe Mobile - 8car - Wh
    ...
    private String ptec; // Période Tarifaire en cours - 4car
    ...
    private Integer iinst; // Intensité instantanée - 3car - A 
    private Integer papp; // Puissance apparente - 5car - VA
    private Integer imax; // Intensitée max - 3 car - A
    private String optarif; // Option tarifaire choisie - 4 car 
    private Integer isousc; // Intensité souscrite - 2 car - A
    private String motdetat; // Mot d'état du compteur - 6car
